...
describe("Atlas", () => {
  ...
  test("keeps encoded Cyrillic, spaced, and Linux backslash routes stable", () => {
    ...
    expect(folderRoute("Раздел\\архив")).toBe(
      "/folders/%D0%A0%D0%B0%D0%B7%D0%B4%D0%B5%D0%BB%5C%D0%B0%D1%80%D1%85%D0%B8%D0%B2",
    );
  });
